...
class TestCoupledTraining(unittest.TestCase):
    ...
    def test_rnn_rev_training(self):
        ...
        results = joint_model_training(
            ...
            10,
            gold_standard=self.prior,
            dynamic_model_type='rnn_decoder'
        )

        self.assertEqual(len(results), 4)

    def test_gru_rev_training(self):
        ...
        results = joint_model_training(
            ...
            10,
            gold_standard=self.prior,
            dynamic_model_type='gru_decoder'
        )

        self.assertEqual(len(results), 4)

    def test_lstm_rev_training(self):
        ...
        results = joint_model_training(
            ...
            10,
            gold_standard=self.prior,
            dynamic_model_type='lstm_decoder'
        )
