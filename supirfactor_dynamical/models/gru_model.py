...
class TFGRUAutoencoder(torch.nn.Module, _TF_RNN_mixin):
    ...
    def __init__(
        ...
        # Build GRU to encode single hidden (TF) layer
...
class TFGRUDecoder(torch.nn.Module, _TF_RNN_mixin):

    type_name = "gru_decoder"
    ...
    def __init__(
        ...
        self._intermediate = torch.nn.GRU(
            self.k,
            self.k,
            1,
            bias=False,
